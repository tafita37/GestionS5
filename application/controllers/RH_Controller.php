...
class RH_Controller extends CI_Controller {
    ...
    public function formAnnonce() {
        ...
        $this->load->view("pages/nouvelleAnnonceRH", $data);
    ...
    public function newAnnonce() {
        ...
        $this->Annonce_Model->newAnnonce($service, $titre_annonce, $diplome, $filiere, $experience_requis, $distance_maximum, $duree_contrat, $salaire_min, $salaire_max, $v_horaire, $date_depot_final, $age_min, $age_max, $description_annonce);
    ...
    {
        $data["allAnnonce"] = $this->Annonce_Model->findAllAnnonceNonConf();
        $this->load->view("static/header");
    ...
    public function critereAnnonce($id_annonce) {
        ...
        $this->load->view("static/header");
        $this->load->view("pages/critereAnnonceRH", $data);
        $this->load->view("static/footer");
    }
    ...
    public function newCritereAnnonce() {
        ...
        redirect("RH_Controller/listeAnnonce");
    }
    ...
    public function listeAllAnnonce()
    {
        ...
        $this->load->view("static/header");
        $this->load->view("pages/listeAllAnnonceRH", $data);
        $this->load->view("static/footer");
    ...
    public function detailAnnonce($id_annonce) {
        ...
        $this->load->view('static/header');
        $this -> load -> view("pages/detailAnnonceRH", $data);
		$this->load->view('static/footer');
    }
}
