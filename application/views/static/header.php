...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url("assets/css/mirentyCss/QCMFilling.css"); ?>">
      ...
      <div class="container">
        <div class="row align-items-lg-center">
          ...
          <div class="col-lg-6 order-lg-1 text-center mx-auto">
            ...
            <p class="lead mb-5 text-white" data-aos="fade-up" data-aos-delay="100">July 3, 2018 &bullet; by <a href="#"
                class="text-white">John Smith</a></p>
          </div>
