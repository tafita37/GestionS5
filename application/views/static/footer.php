      ...
      <div class="col-md-12 text-center">
        <p>
          ...
          <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i
            class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"
...
<script src="<?php echo base_url("assets/js/extras/jquery.js"); ?>"></script>
  ...
  <script src="<?php echo base_url("assets/vendor/minimalist-picker/dobpicker.js"); ?>"></script>
  ...
  <script src="<?php echo base_url("assets/js/ajoutCv.js"); ?>"></script>
</body>
