    ...
    <div class="col-md-5 m-auto">
        <h3 class="mb-5 m-auto">Creer une annonce en <?php  echo $responsable["nom_service"]; ?></h3>
        <form action="<?php echo site_url("Responsable_Controller/newAnnonce"); ?>" class="p-5 bg-light" method="post">
        ...
        <a href="<?php echo site_url("Responsable_Controller/listeAnnonce") ?>" class=" btn-primary py-3 px-4 mr-3">Voir la liste des annonces non configures</a>
        <a href="<?php echo site_url("Responsable_Controller/listeAllAnnonce") ?>" class=" btn-primary py-3 px-4 mr-3">Voir toutes les annonces</a>
    </div>
</div>