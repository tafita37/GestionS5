...
<h2>
    Liste de toutes les annonces en <?php echo $responsable["nom_service"]; ?>
</h2>
<table class="table">
    ...
    <?php
        for($i=0; $i<count($allAnnonce); $i++) {
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url("Responsable_Controller/detailAnnonce/".$allAnnonce[$i]["id_annonce"]); ?>">
                        Details
                    </a>
                </td>
            </tr>
  ...
  <a href="<?php echo site_url("Responsable_Controller/formAnnonce") ?>" class=" btn-primary py-3 px-4 mr-3 m-auto">Rajouter une annonce</a>